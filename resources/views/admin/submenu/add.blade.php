    ...
    <div id="content-wrapper">
        ...
        @if(session()->has('message-success'))
            <div class="alert alert-success alert-dismissible">
                ...
                <strong>Success!</strong> Add New SubMenu .
            </div>
        @elseif(session()->has('message-fail'))
            <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Error!</strong> Add New SubMenu .
            </div>
        @endif
        <form id="add_submenu_form" action="{{route('admin.submenu.add')}}" method="post">
            {{ csrf_field() }}
            <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-label-group">
                                ...
                                @foreach($listMenu as $item)
                                    <input type="radio" id="menu_id" value="{{$item->menu_id}}" name="menu_id" >{{$item->name}}
                                @endforeach
                            </div>
