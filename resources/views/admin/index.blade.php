        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Alego Admin Dashboard</h4>
                </div>
                <div>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Event Table</p>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width: 100px;height: 100px">
                              <img src="https://i.ytimg.com/vi/7SlILk2WMTI/maxresdefault.jpg"  alt="Cinque Terre">
                          </td>
                          <td> marvel</td>
                          <td>
